...
import { Code2, Zap, FileStack, Database } from "lucide-react";
import { useDebtStore } from "@/stores/debt-store";
import type { DebtCategory, DebtCategorySummary } from "@/lib/debt/types";
import { cn } from "@/lib/utils";

const CATEGORY_ICONS: Record<DebtCategory, typeof Code2> = {
  apex: Code2,
  automation: Zap,
  metadata: FileStack,
  schema: Database,
...
function DebtCategoryCard({
  summary,
  isSelected,
  onClick,
}: {
  summary: DebtCategorySummary;
  isSelected: boolean;
  onClick: () => void;
}) {
